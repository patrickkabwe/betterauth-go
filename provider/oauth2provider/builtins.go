...
func Discord(opts Options) *Provider {
	return New(Config{
		...
		Scopes: []string{"identify", "email"}, DisableDefaultScope: opts.DisableDefaultScope,
...
func Dropbox(opts Options) *Provider {
	return New(Config{
		...
		ClientID: opts.ClientID, ClientSecret: opts.ClientSecret,
		Scopes: []string{"account_info.read"}, DisableDefaultScope: opts.DisableDefaultScope,
...
func Figma(opts Options) *Provider {
	return New(Config{
		...
		ClientID: opts.ClientID, ClientSecret: opts.ClientSecret,
		Scopes: []string{"current_user:read"}, DisableDefaultScope: opts.DisableDefaultScope,
...
func GitLab(opts Options) *Provider {
	return New(Config{
		...
		ClientID: opts.ClientID, ClientSecret: opts.ClientSecret,
		Scopes: []string{"read_user"}, DisableDefaultScope: opts.DisableDefaultScope,
...
func Notion(opts Options) *Provider {
	...
	return New(Config{
		...
		ClientID: opts.ClientID, ClientSecret: opts.ClientSecret,
		Scopes: nil, DisableDefaultScope: opts.DisableDefaultScope,
...
func Slack(opts Options) *Provider {
	return New(Config{
		...
		ClientID: opts.ClientID, ClientSecret: opts.ClientSecret,
		Scopes: []string{"openid", "profile", "email"}, DisableDefaultScope: opts.DisableDefaultScope,
...
func Spotify(opts Options) *Provider {
	return New(Config{
		...
		ClientID: opts.ClientID, ClientSecret: opts.ClientSecret,
		Scopes: []string{"user-read-email"}, DisableDefaultScope: opts.DisableDefaultScope,
...
func Vercel(opts Options) *Provider {
	return New(Config{
		...
		ClientID: opts.ClientID, ClientSecret: opts.ClientSecret,
		Scopes: opts.Scopes, DisableDefaultScope: opts.DisableDefaultScope,
